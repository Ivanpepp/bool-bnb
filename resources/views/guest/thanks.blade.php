@extends("layouts.app")
@section("content")
<div class="container" id="my-thanks-wrap">
    <div class="my-border-wrap border shadow p-lg-5 m-lg-5 p-sm-2 m-sm-2 mt-sm-5">
        <div class="row  d-flex justify-content-center ">
            <h1 class=" text-center col-lg-12 col-sm-10 pt-5 pb-4 mb-5 pt-sm-3 text-uppercase my-text-color">Grazie per averci contattato!</h1>
        </div>
        @if ($errors->any())
